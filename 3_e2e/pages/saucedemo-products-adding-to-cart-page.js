...
export class SaucedemoProductsAddingToCartPage {
  ...
  async addToCartOnCard () {
    ...
    // await expect(this.page.locator('[data-test="inventory-list"]')).toBeTruthy();
  ...
  async addToCartonCardx2 () {
   ...
   //  await expect(this.page.locator("[import Button, { BUTTON_SIZES, BUTTON_TYPES } from './Button']")).toBeTruthy();
   }
